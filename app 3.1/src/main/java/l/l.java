...
public class l extends Activity implements OnClickListener,OnLongClickListener,Runnable
{
	...
	int s,z,r,s0,z0,r0,su,su0,day,now,run;
	Editor edit;
	Context c;
	ScrollView s1,s2,s3;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		if(su!=0||Build.VERSION.SDK_INT<26)
		{
		...
		b("电池优化","com.android.settings",".Settings$BgOptimizeAppListActivity");
	...
	public void onClick(View v)
	{
		...
		switch(v.getId()){
			...
			case 1:
				...
				break;
			case 2:
				//s="mqqopensdkapi://bizAgent/qm/qr?url=http%3A%2F%2Fqm.qq.com%2Fcgi-bin%2Fqm%2Fqr%3Ffrom%3Dapp%26p%3Dandroid%26k%3DX_wurB9Wk8d0fjn0kwJPgkwGCRiUwp2l";
				s="bXFxb3BlbnNka2FwaTovL2JpekFnZW50L3FtL3FyP3VybD1odHRwJTNBJTJGJTJGcW0ucXEuY29tJTJGY2dpLWJpbiUyRnFtJTJGcXIlM0Zmcm9tJTNEYXBwJTI2cCUzRGFuZHJvaWQlMjZrJTNEWF93dXJCOVdrOGQwZmpuMGt3SlBna3dHQ1JpVXdwMmw";
				s=new String(android.util.Base64.decode(s,android.util.Base64.DEFAULT));
			...
			case 13:
				...
				break;
			case 14:
				startActivity(new Intent(this,ff.class).putExtra("",2));
				break;
	...
	void rt()
	{
		...
		t(sb("CPU频率浮窗","数据仅供参考，切勿当真！(长按浮窗可关闭)"));
		...
		t(sb("SELinux","如果你不认识☝那东西就别点这按钮，否则手机会出错！"));
...
//	}
	...
	private void b(Button b,String n)
	{
		...
		b.setTextSize(ts);
		b.setTextColor(z);
		//b.setShadowLayer(01f, 0.5f, 0.5f, 0xff000000);
		//b.setGravity(Gravity.CENTER);
		b.setPadding(p,p,p,p);
