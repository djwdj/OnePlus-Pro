...
//	}
	...
	{
		String s1,s2,s3,s4;
		s1=r("cat /sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_cur_freq");
		s2=r("cat /sys/devices/system/cpu/cpu1/cpufreq/cpuinfo_cur_freq");
		s3=r("cat /sys/devices/system/cpu/cpu2/cpufreq/cpuinfo_cur_freq");
		s4=r("cat /sys/devices/system/cpu/cpu3/cpufreq/cpuinfo_cur_freq");
