...
public class l extends Activity implements OnClickListener,OnLongClickListener,Runnable
{
	...
	int s,z,r,s0,z0,r0,su,su0,day,now,run,up;
	Editor edit;
	static Context c;
	ScrollView s1,s2,s3;
	...
	protected void onRestart()
	{
		...
		l.setBackground(wm.getDrawable());
		super.onRestart();
	}
	...
	public void onClick(View v)
	{
		...
		switch(v.getId()){
			...
			case 1:
				...
				break;
			case 2:
				//s="mqqapi://card/show_pslcard?card_type=group&uin=92545279";
				s="bXFxYXBpOi8vY2FyZC9zaG93X3BzbGNhcmQ/Y2FyZF90eXBlPWdyb3VwJnVpbj05MjU0NTI3OQ==";
...
//	}
	...
	void c(String s)
	{
		((android.content.ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE)).setText(s);

	}
	
	void Toast(Object s)
	{
		Toast.makeText(this,s.toString(),50).show();
	}
